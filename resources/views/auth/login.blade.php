        ...
        <form method="POST" autocomplete="off" action="{{ route('login') }}">
            ...
            <div class="pre-div">
                ...
                <div class="auth-input-div">
                    ...
                    <input type="password" autocomplete="off" name="password" required class="form-control input-auth" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                </div>
                <div class="forgot">
